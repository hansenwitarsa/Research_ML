...
class DataIntoArray:
    ...
    def process_folder(folder_path, obs_len=8, pred_len=12, max_ped=64):
        ...
        dataset_files = [f for f in os.listdir(folder_path) if f.endswith('.txt')]
        ...
        return all_x_data, all_t_data

folder_path = "/Users/hanse/Documents/Research/datasets_process/eth/train"

x, y=  DataIntoArray.process_folder(folder_path, obs_len = 8, pred_len = 12, max_ped = 64)
print(x.shape)